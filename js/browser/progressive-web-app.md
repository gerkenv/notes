...
- https://web.dev/learn/pwa/caching/#offline-ready
  ...
  - Your PWA should not render a browser's error message saying that the application couldn't load the page. Instead use your service worker to show your own messaging, avoiding a generic and confusing browser error
